var gulp       = require('gulp'), // Подключаем Gulp
	...
	notify 			 = require("gulp-notify");//Уведомления в трее об ошибках
	...
	return gulp.src('app/sass/**/*.sass') // Берем источник
		.pipe(plumber({
			errorHandler: notify.onError(function(err){
				return{
					title: 'Err SASS to CSS',
					message: err.message
				};
			})
		}))//Отлавливаем ошибки, выводим сообщение и прекращаем поток при их наличии
